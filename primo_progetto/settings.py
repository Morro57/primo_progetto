...
SECRET_KEY = 'django-insecure-36t88b%zi1%0vf_%vrq%!@0ocgr6lmb_*y4d#isnfro*j22sp_'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'prima_app/templates/prima_app'),
                 ...
                 os.path.join(BASE_DIR,'news/template/news'),
                 os.path.join(BASE_DIR,'voti,template,voti')],
